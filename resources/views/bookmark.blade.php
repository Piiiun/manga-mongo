    ...
    <div class="min-h-screen bg-linear-to-b from-gray-950 to-black">
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div id="empty-state" class="hidden">
                <div class="bg-gray-900/50 rounded-2xl p-12 text-center max-w-md mx-auto border border-gray-800">
            ...
            {{-- Manga Grid --}}
            <div id="manga-grid" class="hidden grid md:gap-5 gap-2.5 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                    ...
                    <div class="bg-gray-900/50 border border-gray-800 rounded-xl p-4 flex gap-4 hover:border-amber-500/50 transition-colors">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-4 text-sm">
                                ...
                                <span class="px-2 py-1 bg-gray-800 text-gray-300 rounded text-xs">${manga.status || 'Unknown'}</span>
                            </div>
                        </div>
                        <button onclick="removeBookmark(${manga.id})" 
