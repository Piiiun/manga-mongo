<x-layout title="Register" title="Login" :noFooter="true" :noPadding="true">
    <div class="min-h-screen flex items-center justify-center bg-gray-900 px-0 md:px-4 md:py-12 py-2">
        <div class="bg-gray-800 p-8 rounded-2xl shadow-xl w-full max-w-md mt-8 scale-80 md:scale-100">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <button type="submit" class="w-full bg-amber-500 hover:bg-amber-400 text-black font-bold py-3 px-4 rounded-lg transition-colors">
                    Daftar
                </button>
