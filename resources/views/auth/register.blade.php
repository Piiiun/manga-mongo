<x-layout title="Register" title="Login" :noFooter="true" :noPadding="true">
    <div class="min-h-screen flex items-center justify-center bg-bg px-0 md:px-4 md:py-12 py-2">
        <div class="bg-card-3 p-8 rounded-2xl shadow-xl w-full max-w-md mt-8 scale-80 md:scale-100">
            <h2 class="text-3xl font-bold text-text mb-6 text-center">Daftar</h2>
            
            @if ($errors->any())
                <div class="bg-red-500/20 border border-error text-red-400 px-4 py-3 rounded-lg mb-4">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4">
                    <label class="block text-text-second mb-2 font-semibold">Username</label>
                    <div class="relative">
                        ...
                        <input type="text" 
                            ...
                            autofocus
                            placeholder="Nama"
                            class="pl-10 w-full px-4 py-3 rounded-lg bg-border text-text border border-border-2 focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/50">               
                    </div>
                </div>
                
                <div class="mb-4">
                    <label class="block text-text-second mb-2 font-semibold">Email</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div class="mb-4">
                    <label class="block text-text-second mb-2 font-semibold">Password</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <input type="password" 
                            ...
                            required
                            placeholder="••••••••"
                            class="pl-10 pr-12 w-full px-4 py-3 rounded-lg bg-border text-text border border-border-2 focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/50">
                ...
                <div class="mb-6">
                    <label class="block text-text-second mb-2 font-semibold">Konfirmasi Password</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <p class="text-text-second text-center mt-6">
                    Sudah punya akun? 
                    <a href="{{ route('login') }}" class="text-accent hover:text-accent-hover font-semibold">
                        Login
                    </a>
                </p>
            </form>
