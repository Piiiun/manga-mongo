...
>
    <div id="reader-area" class="min-h-screen bg-linear-to-b from-gray-950 to-black">
        ...
        <div id="reader-topbar" class="sticky top-0 z-50 bg-gray-900/95 backdrop-blur-sm border-b border-gray-800">
            <div class="px-2 sm:px-4 lg:px-6 py-1.5 sm:py-2">
                ...
                <div class="flex items-center justify-between gap-2 sm:hidden">
                    ...
                    <div id="autoscroll-container" class="flex items-center gap-1 bg-gray-800 border border-gray-700 rounded px-1.5 py-1">
                        <button id="autoscroll-play" type="button" class="p-1 hover:bg-gray-700 rounded text-gray-300 hover:text-white transition-colors" title="Mulai Auto Scroll">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                        </button>
                        <button id="autoscroll-pause" type="button" class="p-1 hover:bg-gray-700 rounded text-gray-300 hover:text-white transition-colors hidden" title="Hentikan Auto Scroll">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center gap-1">
                        <button 
                            ...
                            class="bookmark-toggle p-1.5 hover:bg-gray-800 rounded-lg text-gray-300 hover:text-white transition-colors" title="Bookmark">
                        ...
                        <button onclick="window.scrollToComments && window.scrollToComments()" class="p-1.5 hover:bg-gray-800 rounded text-gray-300 hover:text-white transition-colors relative" title="Comments">
                    ...
                    <div class="flex items-center justify-between gap-3 mb-2">
                        ...
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <div id="autoscroll-container-desktop" class="flex items-center gap-1.5 bg-gray-800 border border-gray-700 rounded-lg px-2 py-1">
                                <button id="autoscroll-play-desktop" type="button" class="p-1 hover:bg-gray-700 rounded text-gray-300 hover:text-white transition-colors" title="Mulai Auto Scroll">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                </button>
                                <button id="autoscroll-pause-desktop" type="button" class="p-1 hover:bg-gray-700 rounded text-gray-300 hover:text-white transition-colors hidden" title="Hentikan Auto Scroll">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                </button>
                        ...
                        <div class="flex items-center gap-1.5">
                            <button onclick="window.scrollToComments && window.scrollToComments()" class="p-1.5 hover:bg-gray-800 rounded-lg text-gray-300 hover:text-white transition-colors relative" title="Comments">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/>
                                </svg>
                                @if($chapter->comments()->topLevel()->count() > 0)
                            ...
                            <button 
                                type="button"
                                id="share-button"
                                class="share-button p-1.5 hover:bg-gray-800 rounded-lg text-gray-300 hover:text-white transition-colors" title="Share"
                            ...
                            <button class="p-1.5 hover:bg-gray-800 rounded-lg text-gray-300 hover:text-white transition-colors" title="Settings">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button class="p-1.5 hover:bg-gray-800 rounded-lg text-gray-300 hover:text-white transition-colors" title="Fullscreen">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4"/>
                                </svg>
                            </button>
        ...
        <div id="autoscroll-login-modal" class="hidden fixed inset-0 bg-black/80 backdrop-blur-sm z-50 overflow-y-auto">
            <div class="min-h-screen px-4 py-8 flex items-center justify-center">
                <div class="bg-gray-900 rounded-xl border border-gray-800 p-6 max-w-md w-full">
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2">Login untuk Memakai Fitur Auto Scroll</h3>
                        <p class="text-gray-400 text-sm mb-6">
                            Fitur Auto Scroll memungkinkan Anda membaca manga secara otomatis dengan berbagai kecepatan. Login untuk mengakses fitur ini.
                        </p>
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <button onclick="closeAutoscrollLoginModal()" 
