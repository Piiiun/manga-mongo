    ...
    <div class="min-h-screen py-10">
        <div class="max-w-2xl mx-auto px-4">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-black dark:text-white">Tambah Banyak Chapter Sekaligus</h1>
            ...
            <form action="{{ route('admin.manga.chapters.bulk-store', $manga) }}" method="POST"
                ...
                {{-- Chapter Numbers --}}
                <div>
                    <label class="block text-black dark:text-white font-medium mb-2">Chapter Numbers <span class="text-red-500">*</span></label>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">Support decimal: 1, 1.5, 2, 2.5, etc</p>
                </div>
                ...
                {{-- Info Box --}}
                <div class="bg-blue-500/40 dark:bg-blue-900/20 border border-blue-800 rounded-lg p-4">
                ...
                {{-- Examples Box --}}
                <div class="bg-amber-500/40 dark:bg-amber-900/20 border border-amber-800 rounded-lg p-4">
                    <div class="flex gap-3">
                        <svg class="w-6 h-6 text-amber-600 dark:text-amber-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                        <div class="text-sm text-gray-600 dark:text-gray-300">
                            <p class="font-medium mb-2 text-amber-600 dark:text-amber-400">Contoh Input:</p>
                            <ul class="space-y-1 text-gray-600 dark:text-gray-400">
                                <li><code class="bg-gray-500/50 dark:bg-gray-800 px-2 py-1 rounded">1-10</code> → Membuat chapter 1 sampai 10</li>
                                <li><code class="bg-gray-500/50 dark:bg-gray-800 px-2 py-1 rounded">1,2,3,5,7</code> → Membuat chapter 1, 2, 3, 5, dan 7</li>
                                <li><code class="bg-gray-500/50 dark:bg-gray-800 px-2 py-1 rounded">1-5,7,10-15</code> → Membuat chapter 1-5, 7, dan 10-15</li>
                                <li><code class="bg-gray-500/50 dark:bg-gray-800 px-2 py-1 rounded">1,1.5,2,2.5</code> → Membuat chapter dengan decimal</li>
                            </ul>
                        </div>
                    </div>
                </div>
