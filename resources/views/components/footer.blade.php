        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    ...
                    <li>
                        <a href="{{ route('history.index') }}" class="group flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-amber-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-transform group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                            </svg>
                            Riwayat
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    <li>
                        <a href="{{ route('help.show', 'tentang-kami') }}" class="group flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-amber-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-transform group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                            </svg>
                            Tentang Kami
                    ...
                    <li>
                        <a href="{{ route('help.show', 'kontak') }}" class="group flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-amber-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-transform group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                            </svg>
                            Kontak
                    ...
                    <li>
                        <a href="{{ route('help.show', 'faq') }}" class="group flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-amber-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-transform group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                            </svg>
                            FAQ
                    ...
                    <li>
                        <a href="{{ route('help.show', 'privacy-policy') }}" class="group flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-amber-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-transform group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                            </svg>
                            Privacy Policy
                    ...
                    <li>
                        <a href="{{ route('help.show', 'terms-of-service') }}" class="group flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-amber-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-transform group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                            </svg>
                            Terms of Service
