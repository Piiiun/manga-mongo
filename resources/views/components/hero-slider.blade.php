                        ...
                        <div class="relative flex-1 space-y-4 text-white">
                            ...
                            <div class="flex flex-wrap gap-3 pt-2">
                                <a href="{{ route('manga.detail', $manga->slug) }}"
                                   class="inline-flex gap-2 items-center justify-center rounded-full bg-accent px-6 py-2 text-sm font-semibold text-white hover:bg-accent-hover transition">
