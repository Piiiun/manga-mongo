<section class="relative mt-12">
    ...
    <div class="relative">
        ...
        <div class="mb-8 flex items-center justify-between sm:mx-8">
            ...
            <a href="{{ route('manga.list', ['sort' => 'latest']) }}" class="group flex items-center gap-2 rounded-full bg-linear-to-r from-accent/10 to-accent-strong/10 px-2.5 sm:px-5 py-2.5 font-semibold text-accent-hover ring-1 ring-accent/30 transition-all hover:ring-accent/60 mr-2 sm:mr-0">
