<section class="relative mt-12">
    ...
    <div class="absolute -top-20 left-0 h-40 w-40 rounded-full bg-amber-500/10 blur-3xl"></div>
    <div class="absolute -top-10 right-0 h-60 w-60 rounded-full bg-red-500/10 blur-3xl"></div>
    ...
    <div class="relative">
        ...
        <div class="mb-8 flex items-center justify-between sm:mx-8">
            ...
            <a href="{{ route('manga.list', ['sort' => 'latest']) }}" class="group flex items-center gap-2 rounded-full bg-linear-to-r from-amber-500/10 to-red-500/10 px-2.5 sm:px-5 py-2.5 font-semibold text-amber-400 ring-1 ring-amber-500/30 transition-all hover:ring-amber-500/60 mr-2 sm:mr-0">
        ...
        @if($latestMangas->isEmpty())
            <div class="flex flex-col items-center justify-center py-16">
                ...
                <p class="mt-4 text-gray-400">Belum ada manga yang tersedia</p>
            </div>
        @endif
    </div>
</section>