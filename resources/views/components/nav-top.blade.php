        ...
        <div class="gap-6 justify-end text-white hidden md:flex font-medium items-center">
            ...
            @auth
                ...
                <div class="relative group">
                    <button class="flex items-center gap-2 hover:text-gray-400 transition-colors duration-200 focus:outline-none">
            ...
            @else
                {{-- User belum login --}}
                <a href="{{ route('login') }}" class="px-4 py-2 bg-amber-500 hover:bg-amber-400 text-black font-semibold rounded-full transition-all duration-200 hover:shadow-lg hover:shadow-amber-500/30 hover:scale-105">
                    Login
                </a>
            @endauth
        </div>
