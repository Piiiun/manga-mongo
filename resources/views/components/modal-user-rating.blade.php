                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center gap-2">
                                <span class="text-4xl font-bold text-text">{{ $manga->average_rating ?? 0 }}</span>
                                <div>
                                    <div class="flex">
                                        @for($i = 1; $i <= 10; $i++)
                                            <svg class="w-4 h-4 {{ $i <= ($manga->average_rating ?? 0) ? 'text-rating fill-current' : 'text-gray-600' }}" viewBox="0 0 20 20">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-1">
                                        ...
                                        <div class="flex items-center gap-1">
                                            <span class="text-text font-bold">{{ $rating->rating }}</span>
                                            <svg class="w-5 h-5 text-rating fill-current" viewBox="0 0 20 20">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                            </svg>
                                        </div>
                                    </div>
